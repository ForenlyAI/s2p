...
The heart of the system. **Vertex AI** performs a semantic comparison between the **Invoice**, **Purchase Order**, and **Goods Receipt**. It understands context (e.g., matching "Coffee Filter" to "Regular Filter") where rigid rules fail.
...
│   ├── services/       # Google Maps, Vertex AI, Document AI integrations
│   ├── main.py         # Application Entry Point
│   └── database.py     # SQLAlchemy Models (PO, Invoices, Suppliers)
├── frontend/           # React Dashboard for S2P Monitoring (Work in Progress)
├── docs/               # SOPs and Architectural Documentation
└── scripts/            # Deployment and DB migration scripts
```

## 🛠️ Setup & Installation

*(Professional setup instructions here...)*

# 🏗️ Enterprise Pilot Client — Kahve Filtre S2P Projesi

> **Müşteri:** Enterprise Pilot Client  
...
Enterprise Pilot Client'ın kahve filtre tedarik sürecinin **Source-to-Pay (S2P)** pipeline ile uçtan uca otomasyonu.
...
└── reports/                     ← Enterprise Pilot Client'a sunumlar
    └── roi_report.md
```
